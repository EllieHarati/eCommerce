							...
							<div class ="col-md-3 col-xs-12">
								<?php
									...
									if (isset ($_SESSION['first_name']) && ($_SESSION['email'])) {
										echo "<a href='payment.php' class='btn btn-success btn-lg btn-block' role='button'>Proceed Payments (Cards)</a>";
										echo "<a href=paypal_test.php class='btn btn-primary btn-lg btn-block' role='button'>Proceed Payments (Paypal)</a>";
									} else {
