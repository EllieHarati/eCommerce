							...
							<div class = "col-md-12 colxs-12">
								...
								<?php
									...
									if (isset ($_SESSION['first_name']) && isset ($_SESSION['last_name'])) {
										...
										echo "<p class = 'text-success'><span class= 'glyphicon glyphicon-flag'></span> Copy of your information have been sent to your email address.</p>";
										echo "<a href = 'biara.php'><span class= 'glyphicon glyphicon-shopping-cart'></span> Complete your payment</a>";
										session_destroy(); 			
									} if (isset ($_SESSION['msg']))
									{
										echo "<p class = 'text-danger'><span class= 'glyphicon glyphicon-remove'></span>" . " " . $_SESSION['msg'] .  "</p>";
										session_destroy();
									}
								?>
							</div>
