...
<html lang="en">
  <head>
    ...
    <title>Biara - Products Detail</title>

    <!-- Bootstrap -->
    <link href="css/bootstrap.min.css" rel="stylesheet">
	<link href="css/details_item.css" rel="stylesheet">
  ...
  <body>
	<!-- Header -->
	<nav class="navbar navbar-default" style = "background-color:#90C3D4 !important;">
	  <div class="container-fluid">
		...
		<div class="navbar-header">
		  ...
		  <a class="navbar-brand" href="biara.php">Biara</a>
		</div>
...
<div class = "container">
	<div class = "row">
		...
		<div class = "col-md-9 col-sm-9 col-xs-12">
			<div class="thumbnail">
			  <img src="images/800x300.png" alt="Item Image">
			  <div class="caption">
			...
			<div class = "well">
				...
				<div class = "row">
					<div class = "col-md-12>
						...
						<span class = "glyphicon glyphicon-star-empty"></span>
						Anonymous
						<span class = "puul-right">3 days ago</span>
	...
	<footer>
		<div class - "row">
			<div class = "col-md-12">
				...
				<p>Copyright &copy; 2016. <a href = "http://www.biara.com.au"> Biara </a></p>
			</div>
		</div>
	</footer>
</div>
