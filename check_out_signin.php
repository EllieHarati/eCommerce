				...
				<div class="panel panel-viewcart">
					<div class="panel-heading">
						<div class="panel-title">
							<div class = "row">
								...
								<div class = "col-md-6">
									<a href="products.php" class="btn btn-continueShopping btn-bg pull-right" role="button"><span class = "glyphicon glyphicon-share-alt"></span> Continue Shopping</a>
								</div>
							</div>
						</div>
					</div>
					<div class="panel-body">
						...
						<div class = "row">
							<div class = "col-md-9 col-xs-12 text-right">
								<h5>Want to remove items?</h5>
							</div>
							<div class = "col-md-3 col-xs-12">
								<a href="viewcart.php" class="btn btn-default btn-sm btn-block" role="button">Remove item from the cart</a>
							</div>
						</div>
					</div>
					<div class="panel-footer">
						<div class = "row">
							...
							<div class ="col-md-3 col-xs-12">
								<?php
									if (isset ($_SESSION['first_name']) && ($_SESSION['email'])) {
										echo "<a href='payment.php' class='btn btn-success btn-lg btn-block' role='button'>Proceed with Payments</a>";
									} else {
										echo "<a href='check_out_signin.php' class='btn btn-success btn-lg btn-block' role='button'>Sign in and pay</a>";
										echo "<a href='check_out_signup.php' class='btn btn-success btn-lg btn-block' role='button'>Sign up befor payment</a>";
										}
								?>
							</div>
						</div>
